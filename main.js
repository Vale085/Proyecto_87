...
ctx.lineWidth = 5;
ctx.arc(x = 290, y = 250, r = 40, startAngle = 0, endAngle = 2 * Math.PI);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x = 390, y = 250, r = 40, startAngle = 0, endAngle = 2 * Math.PI);
ctx.stroke();
// De igual forma, crea un círculo rojo en la posición 210 y 40
ctx.beginPath();
ctx.strokeStyle = "red";
ctx.lineWidth = 5;
ctx.arc(x = 490, y = 250, r = 40, startAngle = 0, endAngle = 2 * Math.PI);
ctx.stroke();
// De igual forma, crea un círculo naranja en la posición 300 y 250
ctx.beginPath();
ctx.strokeStyle = "orange";
ctx.lineWidth = 5;
ctx.arc(x = 340, y = 290, r = 40, startAngle = 0, endAngle = 2 * Math.PI);
ctx.stroke();
// De igual forma, crea un círculo verde en la posición 400 y 250
ctx.beginPath();
ctx.strokeStyle = "green";
ctx.lineWidth = 5;
ctx.arc(x = 440, y = 290, r = 40, startAngle = 0, endAngle = 2 * Math.PI);
ctx.stroke();